...
public abstract class ConnectionManager extends AppCompatActivity {

    public ConnectionManager(){}

    public static String TAG = "ScoutComms";
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                ...
                public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
                    ...
                    ConnectionManager.this.onConnectionInitiated(endpoint, connectionInfo);
                }
                    ...
                    if (!result.getStatus().isSuccess()) {
                        logW(
                                String.format(
                                        ...
                                        ConnectionManager.toString(result.getStatus())));
    ...
    /**
     * An optional hook to pool any permissions the app needs with the permissions ConnectionManager
     * will request.
     *
