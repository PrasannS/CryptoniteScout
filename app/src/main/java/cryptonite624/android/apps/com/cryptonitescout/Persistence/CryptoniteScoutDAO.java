...
public class CryptoniteScoutDAO {
    ...
    public void getRankingFromMap(ActionMap a, int teamnum){
        ...
        temparr[3]="B2";
        int[] status = {1};
        r.get(0).setSandstormCargoOne(ActionMapUtils.numScored(temparr, status, false, a.getActions()));
        temparr[0]="A3";
        temparr[1]="B3";
        temparr[2]="A4";
        temparr[3]="B4";
