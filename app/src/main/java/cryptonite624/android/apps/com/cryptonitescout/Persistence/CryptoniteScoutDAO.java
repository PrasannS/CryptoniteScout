...
public class CryptoniteScoutDAO {
    ...
    public void addTeamData(ActionMap a, int teamnum){
        ...
        temparr[3]="B2";
        int[] status = {1};
        r.SandstormCargoOne+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A3";
        temparr[1]="B3";
        temparr[2]="A4";
        temparr[3]="B4";
        cargototal+=r.SandstormCargoOne;
        r.SandstormCargoTwo+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A5";
        temparr[1]="B5";
        temparr[2]="A6";
        temparr[3]="B6";
        cargototal+=r.SandstormCargoTwo;
        r.SandstormCargoThree+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A1";
        temparr[1]="B1";
        temparr[2]="A2";
        temparr[3]="B2";
        cargototal+=r.SandstormCargoThree;
        r.SandstormHatchOne+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A3";
        temparr[1]="B3";
        temparr[2]="A4";
        temparr[3]="B4";
        hatchtotal+=r.SandstormHatchOne;
        r.SandstormHatchTwo+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A5";
        temparr[1]="B5";
        temparr[2]="A6";
        temparr[3]="B6";
        hatchtotal+=r.SandstormHatchTwo;
        r.SandstormHatchThree+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A1";
        temparr[1]="B1";
        temparr[2]="A2";
        temparr[3]="B2";
        ...
        r.TeleopCargoOne+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A3";
        temparr[1]="B3";
        temparr[2]="A4";
        temparr[3]="B4";
        cargototal+=r.TeleopCargoOne;
        r.TeleopCargoTwo+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A5";
        temparr[1]="B5";
        temparr[2]="A6";
        temparr[3]="B6";
        cargototal+=r.TeleopCargoTwo;
        r.TeleopCargoThree+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A1";
        temparr[1]="B1";
        temparr[2]="A2";
        temparr[3]="B2";
        cargototal+=r.TeleopCargoThree;
        r.TeleopHatchOne+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A3";
        temparr[1]="B3";
        temparr[2]="A4";
        temparr[3]="B4";
        hatchtotal+=r.TeleopHatchOne;
        r.TeleopHatchTwo+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        temparr[0]="A5";
        temparr[1]="B5";
        temparr[2]="A6";
        temparr[3]="B6";
        hatchtotal+=r.TeleopHatchTwo;
        r.TeleopHatchThree+=ActionMapUtils.numScored(temparr, status, false, a.actions);
        ...
        r.CxCargoCargoShip=(r.CxCargoCargoShip*(r.MatchesPlayed-1)+ActionMapUtils.numScored(cargoship, all, true, a.actions)/(double)r.MatchesPlayed);
        r.CxHatchCargoShip=(r.CxHatchCargoShip*(r.MatchesPlayed-1)+ActionMapUtils.numScored(cargoship, all, true, a.actions)/(double)r.MatchesPlayed);
